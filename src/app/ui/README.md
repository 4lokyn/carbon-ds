...
|---|---|---|
| `@angular/aria` | `tabs/` only | `@developerPreview`, can shift between minors. `overflow-menu/` used it too until 2026-08-23, and the whole menu family now shares `menu/menu-surface.ts` instead; see the root README on why it had to stop. |
